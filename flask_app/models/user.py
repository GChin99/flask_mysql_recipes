...
# ------------------------Read one (step 3 of 3)-------------------------------
    ...
    def get_by_id (cls, data):
        ...
        results = connectToMySQL("recipes").query_db(query, data) #data needs to be added to the query_db because we are passing that information from the data dictionary created in the controllers file
        print(results)
